...
class FeedControllerTest {
    ...
    public void createFeed_피드_추가() throws Exception {
        ...
        willDoNothing().given(feedService).insertFeed(feedDto, userDto);
    ...
    public void putFeed_피드_업데이트() throws Exception {
        ...
        //모키토로 대신 feedDto를 수정할 수 없는지 확인
        given(feedService.updateFeed(anyLong(), any(FeedDto.class))).willReturn(MainFeedDto.builder()
            .id(1L)
            .content("컨텐츠 내용")
            .display_name("홍길동")
