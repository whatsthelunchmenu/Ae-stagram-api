package com.ae.stagram.service.feed;
...
import com.ae.stagram.domain.feed.ImageRepository;
...
import com.ae.stagram.web.dto.feed.FeedInfoDto;
import com.ae.stagram.web.dto.feed.FeedRequestDto;
import com.ae.stagram.web.dto.feed.FeedResponseDto;
...
public class FeedService {
    ...
    public void insertFeed(FeedRequestDto createFeedRequestDto, UserDto userDto)
        ...
        User user = userRepository.findByUuid(userDto.getUuid())
            .orElseThrow(() -> new AestagramException(ExceptionCode.USER_NOT_FOUND));
    ...
    public FeedInfoDto updateFeed(Long feedId, FeedRequestDto feedRequestDto) throws IOException {
        Feed feed = feedRepository.findById(feedId)
            .orElseThrow(() -> new AestagramException(ExceptionCode.FEED_NOT_FOUND));
